...
<div x-show="showNoAvatarModal" style="display: none;" class="fixed inset-0 z-[9999] flex items-center justify-center p-6"
    ...
    <!-- Modal Content -->
    <div
        class="relative bg-white dark:bg-gray-900 rounded-3xl p-8 max-w-md w-full shadow-2xl flex flex-col items-center text-center">
        <div class="w-20 h-20 bg-yellow-100 dark:bg-yellow-900/30 rounded-full flex items-center justify-center mb-6">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-yellow-600 dark:text-yellow-400"
        ...
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-3">Foto Profil Belum Diatur</h2>
        ...
        <div class="flex flex-col gap-3 w-full">
            ...
            <button @click="showNoAvatarModal = false"
                class="w-full py-3.5 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 rounded-xl font-semibold hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">
                Nanti Saja
            </button>
        </div>
    </div>
