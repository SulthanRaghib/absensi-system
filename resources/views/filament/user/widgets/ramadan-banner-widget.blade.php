...
<x-filament-widgets::widget>
    <div x-data="{
        ...
        {{-- ── MODAL ──────────────────────────────────────────── --}}
        <div x-show="open" x-transition:enter="transition ease-out duration-250" x-transition:enter-start="opacity-0"
            ...
            <div x-show="open" x-transition:enter="transition ease-out duration-300"
                ...
                x-transition:leave-end="opacity-0 scale-95" class="relative z-10 w-full max-w-sm mx-auto">
                <div
                    ...
                    <div class="p-5">
                        <template x-for="(joke, i) in jokes" :key="i">
                            <div x-show="page === i" x-transition:enter="transition ease-out duration-200"
