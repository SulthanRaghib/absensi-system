...
<x-filament-widgets::widget>
    <style>
        .absent-scroll::-webkit-scrollbar {
            width: 5px;
        }

        .absent-scroll::-webkit-scrollbar-track {
            background: transparent;
        }

        .absent-scroll::-webkit-scrollbar-thumb {
            background: #e5e7eb;
            border-radius: 99px;
        }

        .absent-scroll::-webkit-scrollbar-thumb:hover {
            background: #d1d5db;
        }

        .dark .absent-scroll::-webkit-scrollbar-thumb {
            background: #374151;
        }

        .dark .absent-scroll::-webkit-scrollbar-thumb:hover {
            background: #4b5563;
        }
