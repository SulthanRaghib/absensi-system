    ...
    <div class="app-wrapper">
        <div class="login-card">
            ...
            <div x-data="loginForm()">
                <!-- Fraud Alert -->
                <div x-show="fraudError" x-transition
                    class="mb-6 bg-red-100 border-l-4 border-red-500 text-red-700 p-4 rounded shadow-md animate-pulse"
                    ...
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="font-bold" x-text="fraudError"></p>
                        </div>
                    </div>
                </div>
